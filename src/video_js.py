...
def run_test():
    ...
    chrome_driver.get(
        ...
        f"file://{os.path.dirname(__file__)}/statics/sdk-automation-videojs.html?src={v.src}&configURL={v.configURL}")
    print(datetime.now())
    time.sleep(2)
        ...
        def send_req():
            def startup_times():
                ...
                if len(startup_times) <= 1:
                    ...
                    def generate_startup_times():
                        file = open("results/results_for_video.js.html", "a")
                        file.write("<h2>Video.js automation testing results</h2>")
                        file.write("\n")
            ...
            def collect_logs():
                ...
                def generate_figure_and_results():
                    ...
                    plt.title('Video quality for Video.js', color='blue')
                    plt.xticks(rotation=-25)
                    plt.pause(0.5)
                    plt.savefig('results/video_quality_for_video.js.png', transparent=True)
                    ...
                    plt.title('HLS errors for Video.js', color='blue')
                    plt.xticks(rotation=-25)
                    plt.pause(0.5)
                    plt.savefig('results/hls_errors_for_video.js.png', transparent=True)

                    file = open("results/video_quality_for_video.js.html", "a")
                    ...
                    file = open("results/latencies_for_Video.js.html", "a")
                    ...
                    file = open("results/hls_errors_for_video.js.html", "a")
                    ...
                    file = open("results/bitrates_and_levels_for_Video.js.html", "a")
            ...
            video_js_png1_html = ("<p><img src='video_quality_for_video.js.png' alt='video quality for video.js' "
                                  "/></p>")
            with open('results/results_for_video.js.html', 'a') as f:
                f.write(video_js_png1_html)
                f.write("\n")

            video_js_quality_html = ("<p><a href='video_quality_for_video.js.html'> "
                                     "video quality for video.js</a></p>")
            with open('results/results_for_video.js.html', 'a') as f:
                f.write(video_js_quality_html)
                f.write("\n")

            video_js_png2_html = ("<p><img src='hls_errors_for_video.js.png' alt='hls errors for video.js' "
                                  "/></p>")
            with open('results/results_for_video.js.html', 'a') as f:
                f.write(video_js_png2_html)
                f.write("\n")

            video_js_hls_errors_html = ("<p><a href='hls_errors_for_video.js.html'> "
                                        "hls errors for video.js</a></p>")
            with open('results/results_for_video.js.html', 'a') as f:
                f.write(video_js_hls_errors_html)
                f.write("\n")

            video_js_latencies_html = "<p><a href='latencies_for_video.js.html'> latencies for video.js</a></p>"
            with open('results/results_for_video.js.html', 'a') as f:
                f.write(video_js_latencies_html)
                f.write("\n")

            video_js_bitrates_and_levels_html = ("<p><a href='bitrates_and_levels_for_video.js.html'> "
